...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 font-inter text-gray-800 py-16 px-6 md:px-12">
    <div className="container mx-auto max-w-3xl bg-white p-8 rounded-lg shadow-xl">
      ...
      <p className="mb-4 text-gray-700">We implement reasonable security measures to protect your information. However, no method of transmission over the Internet is 100% secure.</p>
      <h2 className="text-2xl font-semibold text-purple-700 mt-8 mb-2">Your Choices</h2>
      <p className="mb-4 text-gray-700">You may contact us to update, correct, or delete your personal information. You may also opt out of receiving communications from us at any time.</p>
      <h2 className="text-2xl font-semibold text-purple-700 mt-8 mb-2">Contact Us</h2>
      <p className="mb-4 text-gray-700">If you have any questions about this Privacy Policy, please contact us at <a href="mailto:first.last+privacy072025@gmail.com" className="text-purple-700 underline">first.last+privacy072025@gmail.com</a>.</p>
